...
export default function HomePage() {
  ...
  const otherBrands = TRUSTED_BRANDS.filter((b) => b.name !== "Greenply").slice(
    0,
    7,
  );
  ...
  return (
    <>
          ...
          >
            ...
            <div>
              <div className="badge" style={{ marginBottom: "1.25rem" }}>
                <span
                  style={{ display: "var(--mobile-badge-display, inline)" }}
                >
                  {BUSINESS_DATA.yearsInBusiness}+ Years Trust in Hosur • Est.{" "}
                  {BUSINESS_DATA.establishedYear}
                </span>
                <span style={{ display: "var(--desktop-badge-display, none)" }}>
                  {BUSINESS_DATA.yearsInBusiness}+ Years Trusted Plywood &amp;
                  Hardware Destination in Hosur (Est.{" "}
                  {BUSINESS_DATA.establishedYear})
                </span>
              </div>
              <h1
              ...
              >
                Authorized Greenply dealer &amp; trusted dealers for Greenlam,
                Century, Fevicol (Pidilite), Godrej, Ebco &amp; Faber
                Chimneys—serving homes and commercial projects across Hosur.
              </p>
      ...
      <section
        ...
        style={{ backgroundColor: "var(--linen-white)" }}
      >
        <div
          className="container"
          style={{ textAlign: "center", maxWidth: "840px" }}
        >
          ...
          >
            Over {BUSINESS_DATA.yearsInBusiness} Years of Quality &amp; Trust in
            Hosur
          </h2>
          <p
            style={{
      ...
      <section
        className="section-padding"
        style={{ backgroundColor: "var(--stone-ivory-light)" }}
      >
        <div className="container">
          <div style={{ marginBottom: "3rem", textAlign: "center" }}>
            <h2 style={{ marginBottom: "0.75rem" }}>Core Product Categories</h2>
            <p style={{ maxWidth: "600px", margin: "0 auto" }}>
              Explore our curated selection of architectural materials suited
              for furniture, modular kitchens, wardrobes, and commercial
              interiors.
            </p>
          </div>
        ...
        <div className="container" style={{ maxWidth: "900px" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <p style={{ maxWidth: "600px", margin: "0.5rem auto 0" }}>
              Have questions about kitchen plywood grades, laminate textures, or
              cabinet fittings? Here are practical answers.
            </p>
          </div>
        ...
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <p style={{ maxWidth: "640px", margin: "0.5rem auto 0" }}>
              Authorized dealer for Greenply and trusted dealers for Greenlam,
              Century, Fevicol (Pidilite), Godrej, Ebco, and Faber Chimneys.
            </p>
          </div>
      ...
      <section
        className="section-padding"
        style={{ backgroundColor: "var(--stone-ivory)" }}
      >
        <div className="container">
          <div
            style={{
      ...
      >
        <div className="container" style={{ maxWidth: "720px" }}>
          ...
          >
            Let us help you find the right plywood grade, laminate finish, and
            hardware fittings for your interior requirement. 100% Tax Paid GST
            Billing provided.
          </p>
          <div
            style={{
