      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            >
              Serving homeowners, interior designers, carpenters, and
              construction contractors across Hosur for over{" "}
              {BUSINESS_DATA.yearsInBusiness} years (Est.{" "}
          ...
          <div>
            ...
            >
              ...
              <p style={{ marginTop: "0.85rem" }}>
                <strong className="footer-contrast-color">Phone:</strong>{" "}
                <a
        ...
        {/* Copyright Bar */}
        <div
          className="footer-contrast-color"
          style={{
            paddingTop: "2rem",
            display: "flex",
            flexWrap: "wrap",
